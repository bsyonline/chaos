...
public final class CartServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.rolex.mall.CartService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.rolex.mall.model.ProductOrder,
      com.rolex.mall.model.AddCartReply> getAddToCartMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "addToCart",
      requestType = com.rolex.mall.model.ProductOrder.class,
      responseType = com.rolex.mall.model.AddCartReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<com.rolex.mall.model.ProductOrder,
      com.rolex.mall.model.AddCartReply> getAddToCartMethod() {
    io.grpc.MethodDescriptor<com.rolex.mall.model.ProductOrder, com.rolex.mall.model.AddCartReply> getAddToCartMethod;
      ...
      synchronized (CartServiceGrpc.class) {
        if ((getAddToCartMethod = CartServiceGrpc.getAddToCartMethod) == null) {
          CartServiceGrpc.getAddToCartMethod = getAddToCartMethod =
              io.grpc.MethodDescriptor.<com.rolex.mall.model.ProductOrder, com.rolex.mall.model.AddCartReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "addToCart"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.rolex.mall.model.ProductOrder.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.rolex.mall.model.AddCartReply.getDefaultInstance()))
  ...
  public static abstract class CartServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<com.rolex.mall.model.ProductOrder> addToCart(
        io.grpc.stub.StreamObserver<com.rolex.mall.model.AddCartReply> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncClientStreamingCall(
              new MethodHandlers<
                com.rolex.mall.model.ProductOrder,
                com.rolex.mall.model.AddCartReply>(
