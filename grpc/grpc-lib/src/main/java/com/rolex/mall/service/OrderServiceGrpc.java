...
@javax.annotation.Generated(
    ...
    comments = "Source: MallServerService.proto")
public final class OrderServiceGrpc {

  private OrderServiceGrpc() {}

  public static final String SERVICE_NAME = "com.rolex.mall.OrderService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.rolex.mall.model.Buyer,
      com.rolex.mall.model.Order> getListOrdersMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "listOrders",
      requestType = com.rolex.mall.model.Buyer.class,
      responseType = com.rolex.mall.model.Order.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<com.rolex.mall.model.Buyer,
      com.rolex.mall.model.Order> getListOrdersMethod() {
    io.grpc.MethodDescriptor<com.rolex.mall.model.Buyer, com.rolex.mall.model.Order> getListOrdersMethod;
      ...
      synchronized (OrderServiceGrpc.class) {
        if ((getListOrdersMethod = OrderServiceGrpc.getListOrdersMethod) == null) {
          OrderServiceGrpc.getListOrdersMethod = getListOrdersMethod =
              io.grpc.MethodDescriptor.<com.rolex.mall.model.Buyer, com.rolex.mall.model.Order>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "listOrders"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.rolex.mall.model.Buyer.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.rolex.mall.model.Order.getDefaultInstance()))
  ...
  public static abstract class OrderServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void listOrders(com.rolex.mall.model.Buyer request,
        io.grpc.stub.StreamObserver<com.rolex.mall.model.Order> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                com.rolex.mall.model.Buyer,
                com.rolex.mall.model.Order>(
  ...
  public static final class OrderServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<OrderServiceBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<com.rolex.mall.model.Order> listOrders(
        com.rolex.mall.model.Buyer request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST_ORDERS:
          serviceImpl.listOrders((com.rolex.mall.model.Buyer) request,
              (io.grpc.stub.StreamObserver<com.rolex.mall.model.Order>) responseObserver);
          break;
        default:
  ...
  private static abstract class OrderServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.rolex.mall.service.MallService.getDescriptor();
    }
