...
public class Props {
    ...
    public Props(Map<String, String> prop) {
        this(null, prop);
    }
    ...
    public String put(String key, Object value) {
        return _current.put(key, JSON.toJSONString(value));
    }
    ...
    public void putAll(Map<? extends String, ? extends String> m) {
        ...
        for (Map.Entry<? extends String, ? extends String> entry : m.entrySet()) {
            ...
            this.put(entry.getKey(), value instanceof String ? (String) value : JSONObject.toJSONString(entry.getValue()));
        }
    }
     ...
     * @param p
     */
    public void putAllAppend(Props p) {
        if (p == null) {
            return;
        }
        for (String key : p.getKeySet()) {
    ...
    public Map<String, String> getMapByPrefix(String prefix) {
        Map<String, String> values = _parent == null ? new HashMap<>() : _parent.getMapByPrefix(prefix);
